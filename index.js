...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const newAnimalNamesFilter = data.filter(function(item){
      return item.population < 5;
    })
    return newAnimalNamesFilter;
  }

  console.log('Task 2.3:', lowPopulationAnimals(zooAnimals))
  ...
  */
  ...
  function USApop(data){
    const totalAnimalPop = data.reduce(function(accumulator, item){
      return accumulator + item.population;
    },0);
    return totalAnimalPop;
    }
  
    console.log('Task 2.4:', USApop(zooAnimals));
...
class ChildTwo extends CuboidMakerTwo {
  constructor(attributes) {
    super(attributes);
  }
}
